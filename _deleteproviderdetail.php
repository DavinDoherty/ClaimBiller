    ...
    <div class="container" id="container">
        ...
        <?php include("includes/header.html");?>
            ...
            <div><h4>DELETE PROVIDER</h4></div>
                ...
                <form method="post" action="confirmdeleteprovider.php" class="inputForm">
                <fieldset disabled>
                ...
                <button class='btn'><a href='confirmdeleteprovider.php?providerID=$providerID' style='text-decoration: none;'>DELETE</a></button>
