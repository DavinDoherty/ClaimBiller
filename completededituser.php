            ...
            <br>
             <?php   
                ...
                if(!isset($_SESSION['username']))
                {
                    ...
                    $sql="UPDATE provider SET providerID='$providerID', providerFName='$providerFName', 
                        providerLName='$providerLName', providerEff='$providerEff', providerTerm='$providerTerm', 
