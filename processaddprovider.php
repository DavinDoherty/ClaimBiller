    ...
    <?php include("includes/header.html");?>
		...
		<?php
            ...
            $providerEmail=$_POST["providerEmail"];
                ...
                $sql_insert="INSERT INTO provider(providerID, providerName, providerEff, providerTerm, ssn, contactNbr, providerEmail) 
                    VALUES ('$providerID', '$providerName', '$providerEff', '$providerTerm', '$ssn', '$contactNbr', '$providerEmail')";
            
            if(mysqli_query($link, $sql_insert)) {
            echo "<h2>Provider Added</h2>";
