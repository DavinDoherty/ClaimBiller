...
<body>
    ...
    <div class="container" id="container">
        ...
        <button class='btn2' style='width:150px'><a href='addprovider.php'>ADD PROVIDER</a></button><br><br>

        <button class='btn2' style='width:150px'><a href='editprovider.php'>EDIT PROVIDER</a></button><br><br>

        <button class='btn2' style='width:150px'><a href='deleteprovider.php'>DELETE PROVIDER</a></button><br><br>
